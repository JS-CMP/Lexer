...
EXPR(String, CTOR(value(value)), std::string value)

EXPR(Boolean, CTOR(value(value)), std::string value)

EXPR(RegularExpression, CTOR(value(value)), std::string value)
...
EXPR(Identifier, CTOR(name(name)), std::string name)

EXPR(Grouped, CTOR(expression(std::move(expression))), Expr::Ptr expression)

EXPR(BinaryExpr, CTOR(left(std::move(left)), op(op), right(std::move(right))), Expr::Ptr left, std::string op, Expr::Ptr right)

EXPR(AssignementExpr, CTOR(left(std::move(left)), op(op), right(std::move(right))), Expr::Ptr left, std::string op, Expr::Ptr right)

EXPR(UnaryExpr, CTOR(op(op), expr(std::move(expr))), std::string op, Expr::Ptr expr)

EXPR(PostfixExpr, CTOR(op(op), expr(std::move(expr))), std::string op, Expr::Ptr expr)
...
EXPR(FunctionExpr, CTOR(name(name), params(std::move(params)), body(std::move(body))), std::string name, std::vector<std::string> params, Stmt::Ptr body)

STMT(BlockStmt, CTOR(body(std::move(body))), std::vector<Stmt::Ptr> body)

STMT(VarDecl, CTOR(name(name), init(std::move(init))), std::string name, Expr::Ptr init)
...
STMT(ContinueStmt, CTOR(label(label)), std::string label)

STMT(BreakStmt, CTOR(label(label)), std::string label)
...
STMT(LabeledStmt, CTOR(label(label), body(std::move(body))), std::string label, Stmt::Ptr body)

STMT(ThrowStmt, CTOR(argument(std::move(argument))), Expr::Ptr argument)

STMT(TryStmt, CTOR(block(std::move(block)), param(param), handler(std::move(handler)), finalizer(std::move(finalizer))), Stmt::Ptr block, std::string param, Stmt::Ptr handler, Stmt::Ptr finalizer)

STMT_DEFAULT(DebuggerStmt)

STMT_DEFAULT(EmptyStmt)

STMT(FunctionDecl, CTOR(name(name), params(std::move(params)), body(std::move(body))), std::string name, std::vector<std::string> params, Stmt::Ptr body)
